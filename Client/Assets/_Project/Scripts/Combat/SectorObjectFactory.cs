...
namespace IronExiles.Combat
{
    public static class SectorObjectFactory
    {
        ...
        static void SpawnAsteroidField(Transform parent)
        {
            var fieldParent = new GameObject("AsteroidField");
            fieldParent.transform.SetParent(parent);

            var rockMat = Resources.Load<Material>("AsteroidRock");
        ...
        static void SpawnSpaceStation(Transform parent)
        {
        ...
        static void SpawnNavigationBeacons(Transform parent)
        {
        ...
        static void SpawnLargeAsteroids(Transform parent)
        {
        ...
        static void SpawnCargoContainers(Transform parent)
        {
